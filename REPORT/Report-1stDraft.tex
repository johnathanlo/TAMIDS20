...
\chapter{Model formulation and assessment}
	...
	\tab Having determined a general form for the conditional distribution of the response, we proceeded to fit a simple linear regression model on all covariates.
