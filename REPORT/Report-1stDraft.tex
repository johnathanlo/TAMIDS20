...
\chapter{Model formulation}
	...
	\tab From our data exploration, we see that for major covariates, we do not see a change in the general shape of the distribution itself, only changes in the parameters. 
